...
# K2P_16M架构BIN下载部分
sed -i 's#https://cdn.jsdelivr.net/gh/yIwIoTT9A21nupT/2aXGmlWs/ONywPfH3Rh/pWgXrfGEV6Vtmhy#https://cdn.jsdelivr.net/gh/fangxx3863/overwall_list/K2P_16M/xray#g' ${root}/downbin
sed -i 's#https://cdn.jsdelivr.net/gh/yIwIoTT9A21nupT/2aXGmlWs/ONywPfH3Rh/AlCdr6hj5qHCJmp#https://cdn.jsdelivr.net/gh/fangxx3863/overwall_list/K2P_16M/xray-plugin#g' ${root}/downbin
